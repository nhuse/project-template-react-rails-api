                    ...
                    <div style={{ wordBreak: "break-word", maxWidth: "300px" }}>
                        ...
                        <div style={{color: "#999", textAlign: "center", border: "4px solid grey", borderRadius: "20px", marginBottom: "20px"}}>
                            ...
                            <ul style={{padding: "0", listStyle: "none" }}>
                                <li><h2 style={{margin: '5px' }}>Start a new game</h2> 
                                    SPACE
                                </li> <br/>
                                <li><h2 style={{margin: '5px' }}>Move Tetrominos</h2> 
                                    LEFT/RIGHT arrow keys
                                </li> <br/>
                                <li><h2 style={{margin: '5px', fontSize: "20px" }}>Rotate Tetrominos</h2>  
                                    UP arrow key
                                </li> <br/>
                                <li style={{ marginLeft: '5px', marginRight: '5px' }}>Once 10 rows are cleared, the level and speed will increase. Be careful and have fun!</li>
                            </ul>
                        </div>
                    </div>
                    }
